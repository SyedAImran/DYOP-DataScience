...
# 
# The final method selected was **Rborist**. It has an overall accuracy of 0.878 and sensitivity of 0.895 and specificity of 0.843. The confusion matrix on the test set was:
#   
#   |-----------|--Reference----|--------|
...
# The model selected for our classification/diagnosis of postural abnormalities based on pelvic measurements is **Rborist**. This model had an overall accuracy of `r Accuracy_train` in the training set. The overall accuracy in the test set was `r Accuracy_test`. The confusion matrix for the selected model was:
